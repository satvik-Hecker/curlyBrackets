    ...
    <div className="min-h-screen bg-black w-full relative font-mono">
      ...
      <main className="p-4 md:p-6 space-y-6 relative">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 px-4 md:px-10 lg:px-20">
          ...
          <Card className="bg-teal-500/30 backdrop-blur-sm border-teal-700 transition-all duration-300 ease-in-out hover:scale-[1.01] hover:shadow-xl">
          ...
          <Card className="bg-teal-100/90 backdrop-blur-xl border-white transition-all duration-300 hover:shadow-xl">
